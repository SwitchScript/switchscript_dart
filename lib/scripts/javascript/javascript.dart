...
class JSON {
  static stringify(value, [anu, space]) {
    var data =
        (value.runtimeType.toString() == "String") ? convert.json.decode(value) : value;
    if (space == null) {
      return data;
    } else {
      var spaces = ' ' * space;
      var encoder = convert.JsonEncoder.withIndent(spaces);
      return encoder.convert(data);
    }
  }

  static dynamic parse(value) {
